...
//   ROOT_INCLUDE_PATH=radcore:Analysis root -l -b -q radcore/absShowerTime.C+
// ============================================================================
#include "RadTiming.h"
#include "DataPaths.h"
...
void absShowerTime(){
    ...
    gSystem->mkdir("radcore/figs",kTRUE); c->Print("radcore/figs/abs_shower_time.png");
    printf("wrote radcore/figs/abs_shower_time.png\n");
}

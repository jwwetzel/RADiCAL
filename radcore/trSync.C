...
//   ROOT_INCLUDE_PATH=radcore:Analysis root -l -b -q radcore/trSync.C+
// ============================================================================
...
void trSync(){
    ...
    gSystem->mkdir("radcore/figs",kTRUE); c->Print("radcore/figs/tr0_sync.png");
    printf("wrote radcore/figs/tr0_sync.png\n");
}

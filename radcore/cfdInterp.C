...
//   ROOT_INCLUDE_PATH=radcore:Analysis root -l -b -q radcore/cfdInterp.C+
// ============================================================================
...
void cfdInterp() {
    ...
    gSystem->mkdir("radcore/figs",kTRUE); c->Print("radcore/figs/cfd_interp.png");
    printf("wrote radcore/figs/cfd_interp.png\n");
}

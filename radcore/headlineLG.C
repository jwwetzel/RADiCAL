...
//   ROOT_INCLUDE_PATH=radcore:Analysis root -l -b -q 'radcore/headlineLG.C+("/tmp/radlg/DSB1")'
// ============================================================================
...
void headlineLG(const char* dir="/tmp/radlg/DSB1"){
    ...
    lg->Draw();
    gSystem->mkdir("radcore/figs",kTRUE); c->Print("radcore/figs/headline_lgcfd.png");
    printf("wrote radcore/figs/headline_lgcfd.png\n");
}

...
//   ROOT_INCLUDE_PATH=radcore:Analysis root -l -b -q radcore/fixCFD.C+
// ============================================================================
...
void fixCFD() {
    ...
    gSystem->mkdir("radcore/figs",kTRUE); c->Print("radcore/figs/fix_cfd.png");
    printf("wrote radcore/figs/fix_cfd.png\n");
}

...
//   ROOT_INCLUDE_PATH=radcore:Analysis root -l -b -q radcore/slopeVsThresh.C+
// ============================================================================
...
void slopeVsThresh(){
    ...
    lg->Draw();
    gSystem->mkdir("radcore/figs",kTRUE); c->Print("radcore/figs/slope_vs_thresh.png");
    printf("wrote radcore/figs/slope_vs_thresh.png\n");
}

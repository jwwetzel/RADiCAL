...
//   ROOT_INCLUDE_PATH=radcore:Analysis root -l -b -q radcore/lgCFD.C+
// ============================================================================
...
void lgCFD(){
    ...
    gSystem->mkdir("radcore/figs",kTRUE); c->Print("radcore/figs/lg_cfd.png");
    printf("wrote radcore/figs/lg_cfd.png\n");
}

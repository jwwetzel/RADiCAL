...
//   ROOT_INCLUDE_PATH=radcore:Analysis root -l -b -q radcore/depthCorr.C+
// ============================================================================
...
void depthCorr(){
    ...
    gSystem->mkdir("radcore/figs",kTRUE); c->Print("radcore/figs/depth_corr.png");
    printf("wrote radcore/figs/depth_corr.png\n");
}

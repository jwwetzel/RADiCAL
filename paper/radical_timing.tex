...
clipped-peak foot. Using a microchannel-plate-free differential estimator,
...
\subsection{Method improvement and best resolution}
Recovering the saturated edge with \texttt{hg\_lgcfd} lowers the stochastic term of the
high-light build relative to the published clipped-peak result
($a\!=\!201$ vs $256$~ps$\sqrt{\mathrm{GeV}}$), while leaving the floor unchanged within
errors --- consistent with a steeper, better-measured edge improving the light-driven
term but not the irreducible floor. The best single-event resolution measured, for the
brightest $150$~GeV DSB1 showers, is $25.4$~ps.

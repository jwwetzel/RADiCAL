...
// ----------------------------------------------------------------------------
// Compares a NEW canonical reduced file (reduce/Reducer.C) against the OLD
...
//     'reduce/validateReduce.C+("data/2023/reduced/DSB1/25GeV.root","data/2023/reduced/_validate/25GeV.root")'
// ============================================================================
#include "Schema.h"
#include "TFile.h"
#include "TTree.h"

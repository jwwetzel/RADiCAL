...
//
// Outputs:
//   output/Summary/fiducial_timing_scan.png      — ALL 6 energies
//        overlaid (top-2% E_meas corner sigma_t vs fiducial radius).
//   output/Summary/fiducial_timing_scan_150.png  — 150 GeV detail
...
void fiducialTimingScan()
{
    ...
    for (int e = 0; e < nE; ++e) {
        TString nt = Form("output/%dGeV/ntuple.root", eGeV[e]);
    ...
    // =========================================================================
    {
        ...
        c->Print("output/Summary/fiducial_overfit.png");
        c->Print("output/Summary/fiducial_overfit.pdf");
    ...
    // =========================================================================
    {
        ...
        c->Print("output/Summary/fiducial_timing_scan.png");
        c->Print("output/Summary/fiducial_timing_scan.pdf");
    ...
    if (gTop2[nE-1].GetN() >= 2)
    {
        ...
        c->Print("output/Summary/fiducial_timing_scan_150.png");
        c->Print("output/Summary/fiducial_timing_scan_150.pdf");
    ...
    // =========================================================================
    {
        ...
        c->Print("output/Summary/fiducial_timing_scan_bestbin.png");
        c->Print("output/Summary/fiducial_timing_scan_bestbin.pdf");
    ...
    // =========================================================================
    {
        ...
        c->Print("output/Summary/fiducial_bestbin_jitter.png");
        c->Print("output/Summary/fiducial_bestbin_jitter.pdf");
    ...
    // =========================================================================
    {
        ...
        c->Print("output/Summary/fiducial_binning_fix.png");
        c->Print("output/Summary/fiducial_binning_fix.pdf");
    ...
    // =========================================================================
    {
        ...
        c->Print("output/Summary/fiducial_occ_fits.png");
        c->Print("output/Summary/fiducial_occ_fits.pdf");

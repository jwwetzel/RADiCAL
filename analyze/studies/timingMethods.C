...
// ============================================================================
//
// Reads output/<label>/ntuple.root (produced by processRun.C with the
...
//
// Outputs:
//   output/<label>/timing_methods.pdf     (2 pages, per energy)
//   output/Summary/timing_methods_summary.pdf
//   output/Summary/timing_methods.root
// ============================================================================
...
void timingMethods()
{
    ...
    for (int ie = 0; ie < kNE; ++ie) {
        ...
        // -------------------------------------------------------------------
        TString outPDF = TString("output/") + rc.label + "/timing_methods.pdf";

...
//
// Prerequisites:
//   processRun.C   -- must have produced output/<label>/ntuple.root
//   analyzeResolution.C -- must have produced output/Summary/summary.root
//                          (Page 3 gracefully skipped if summary.root is absent)
//
// Output:
//   output/Summary/channel_integrity.pdf
//
...
void channelIntegrity()
{
    ...
    const TString pdfPath = "output/Summary/channel_integrity.pdf";
    ...
    // =========================================================================
    {
        ...
        const TString sumFile = "output/Summary/summary.root";
        ...
        if (!fSum || fSum->IsZombie()) {
            ...
            msg.DrawLatex(0.50, 0.58,
                "Page 3 requires output/Summary/summary.root");
    ...
    // =========================================================================
    {
        ...
        c.Print("output/Summary/layer1_channelcorr.png");
    ...
    {
        TFile fout("output/Summary/channel_integrity.root", "RECREATE");
        for (int i = 0; i < 8; ++i) {
            TGraph gAF, gRR;
            for (int iRun = 0; iRun < kNRuns; ++iRun) {
        ...
        std::cout << "[channelIntegrity] Wrote "
                  << "output/Summary/channel_integrity.root\n";
    }

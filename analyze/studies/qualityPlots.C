...
// ============================================================================
//
// Reads output/<label>/ntuple.root and produces diagnostic plots to:
...
//
// ── Per-energy output (output/<label>/quality_report.pdf) ──────────
//
//   Page 1  Beam quality
...
//
// ── Summary output ────────────────────────────────────────────────────────────
//   output/Summary/quality_summary.pdf — efficiency vs cut, all energies
//
...
void qualityPlots()
{
    ...
    for (int iRun = 0; iRun < kNRuns; ++iRun) {
        ...
        TString ntFile   = TString("output/") + rc.label + "/ntuple.root";
        ...
        // Open per-energy PDF
        // ---------------------------------------------------------------------
        TString pdfPath = TString("output/") + rc.label
                          + "/quality_report.pdf";
        ...
        // =====================================================================
        {
            ...
            if (rc.energy_GeV > 149. && rc.energy_GeV < 151.)
                c.Print("output/Summary/quality_overview_150.png");
            c.Print(pdfPath + "(");
        }
    ...
    // =========================================================================
    // SUMMARY PDF — output/Summary/quality_summary.pdf
    //
    ...
    if (nRunsDone > 0)
    {
        const TString sumPDF = "output/Summary/quality_summary.pdf";
    ...
    std::cout << "\n[qualityPlots] Done.\n"
              << "  Per-energy:  output/<label>/quality_report.pdf\n"
              << "  Summary:     output/Summary/quality_summary.pdf\n";
}

...
//
// Output:
//   output/Summary/position_correction.pdf  (4 pages)
//   output/Summary/position_correction.root (sigma vs energy graphs)
//
...
void positionCorrection()
{
    ...
    for (int iRun = 0; iRun < kNRuns; ++iRun) {
        ...
        TString path = TString("output/") + rc.label + "/ntuple.root";
    ...
    // Output PDF
    // =========================================================================
    TString outPDF  = "output/Summary/position_correction.pdf";
    TString outROOT = "output/Summary/position_correction.root";

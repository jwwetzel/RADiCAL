...
// Outputs
// -------
//   output/<label>/timing_energy_bins.pdf     (2 pages, per energy)
//   output/Summary/timing_energy_bins_summary.pdf
//   output/Summary/timing_energy_bins.root
//
...
void timingEnergyBins()
{
    ...
    std::cout << "\n[timingEnergyBins] Done!\n"
              << "  output/<label>/timing_energy_bins.pdf  (per-energy, 2 pages)\n"
              << "  " << sumPDF << "\n"

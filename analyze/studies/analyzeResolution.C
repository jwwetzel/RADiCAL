...
void analyzeResolution()
{
    ...
    cSum->Print("output/Summary/resolution_summary.pdf");
    ...
    leg->Draw();
    cTCap->Print("output/Summary/timing_per_capillary.pdf");

    // =========================================================================
    // Write summary ROOT file
    // =========================================================================
    TFile* fSumOut = new TFile("output/Summary/summary.root", "RECREATE");
    gERes->Write();
    gERes_det->Write();
    gLin->Write();
    gTRes->Write();
    ...
    std::cout << "\n[analyzeResolution] Summary written to output/Summary/\n";

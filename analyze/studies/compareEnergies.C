...
// ============================================================================
//
// Pure reader: opens processed ntuples (output/<E>/ntuple.root) and
// summary ROOT files in output/Summary/.  Never reads raw DRS4 data.
//
// Produces four multi-page PDFs in output/Summary/:
//

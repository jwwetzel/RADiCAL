        ...
        Section(
            ...
            appendix_subsections=[
                ...
                Subsection(
                    ...
                    note=(
                        "Beam-independent module centre.  Mean total low-gain energy "
                        "(&Sigma;LG) is projected onto x (tracks in a central y-band) and onto "
                        "y (central x-band); each projection is a flat-topped plateau with sharp "
                        "edges at the module boundary.  The half-maximum crossings give the two "
                        "edges, and the centre is their midpoint &mdash; independent of the beam "
                        "profile within the module.  Generated by moduleCenter.C."
                    ),
                    plots=[PlotEntry(
                    ...
                    finding=(
                        ...
                        f"coordinates, footprint {MOD_WX}&times;{MOD_WY} mm (square, as expected). "
                        "The centre is <em>energy-independent</em> (stable to &plusmn;0.15 mm "
                        "across 25&ndash;150 GeV &mdash; the module does not move with beam energy), "
                        "confirming it as a geometric measurement rather than a beam centroid.  "
                        "This sets the nominal <code>kCalo_x0/y0</code> and centres the transverse "
                        "maps above."
                    ),
                ),
                Subsection(

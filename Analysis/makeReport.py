            ...
            subsections=[
                ...
                Subsection(
                    ...
                    note=(
                        ...
                        "noisy in radius to read an optimum from.  Same Method-A formula, event "
                        "cuts, data-derived centroid and Gaussian-core fit as the headline.  "
                        "Generated by <code>fiducialTimingScan.C</code>."
                    ),
                    plots=[
                        PlotEntry(
                            sumPDF("fiducial_timing_scan.png"),
                            caption=(
                                "Corner &sigma;<sub>t</sub> vs timing fiducial radius (150&nbsp;GeV), "
                                "for a fixed top-2% and top-10% E<sub>meas</sub> selection.  Shaded: "
                                "the optimal plateau (r&nbsp;&le;&nbsp;2.5&nbsp;mm); dashed: the "
                                "adopted r&nbsp;&lt;&nbsp;3&nbsp;mm cut.  The curve is shallow and "
                                "smooth &mdash; a genuine optimisation, not a fluctuation."
                            ),
                            width_pct=66,
                        )
                    ],

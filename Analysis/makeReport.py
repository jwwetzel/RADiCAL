            ...
            subsections=[
                ...
                Subsection(
                    ...
                    note=(
                        ...
                        "actually optimised or merely assumed.  To answer it cleanly we scan the "
                        "(DW&minus;UP)/2 corner &sigma;<sub>t</sub> versus fiducial radius at "
                        "150&nbsp;GeV &mdash; but using a <em>stable</em> high-E<sub>meas</sub> "
                        "selection (the top 2% and 10% by &Sigma;A<sub>LG</sub>) rather than the "
                        "single floating best-bin, whose narrow selection is too statistically "
                        "noisy in radius to read an optimum from.  We run this at <em>all six "
                        "energies</em> (and, for the headline energy, both the top-2% and top-10% "
                        "selections).  Same Method-A formula, event cuts, data-derived centroid and "
                        "Gaussian-core fit as the headline.  Generated by "
                    ...
                    plots=[
                        PlotEntry(
                            ...
                            caption=(
                                "All six energies: corner &sigma;<sub>t</sub> (top-2% E<sub>meas</sub>) "
                                "vs timing fiducial radius.  The dependence is shallow at every energy "
                                "(higher energy &rarr; lower &sigma;<sub>t</sub>); r&nbsp;=&nbsp;3&nbsp;mm "
                                "(dashed) is near-optimal throughout &mdash; the optimum itself at "
                                "25&nbsp;GeV and within ~1&ndash;2&nbsp;ps of it at higher energies &mdash; "
                                "so one 3&nbsp;mm timing cut suits all six runs."
                            ),
                            width_pct=66,
                        ),
                        PlotEntry(
                            ...
                            caption=(
                                "Headline-energy (150&nbsp;GeV) detail: the top-2% and top-10% selections "
                                "both show a shallow optimal plateau for r&nbsp;&le;&nbsp;2.5&nbsp;mm and "
                                "gentle degradation beyond &mdash; a genuine, smooth optimisation, not a "
                                "fluctuation.  (The single-best-bin headline then keeps 3&nbsp;mm for the "
                                "statistics it needs; see below.)"
                            ),
                            width_pct=66,
                        ),
                    ],
                    finding=(
                        ...
                        "&mdash; exactly the kind of single-radius cherry-pick we reject.  Net: the "
                        "timing fiducial is set by an explicit optimisation, and 3&nbsp;mm wins."
                    ),
                ),
                Subsection(

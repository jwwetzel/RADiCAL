        ...
        Section(
            ...
            subsections=[
                ...
                Subsection(
                    ...
                    title="Is the r &lt; 3 mm timing fiducial optimal &mdash; or just convenient?",
                    note=(
                        "The hero above draws two fiducial circles: r&nbsp;&lt;&nbsp;2&nbsp;mm for "
                        "energy (tight, for shower containment) and r&nbsp;&lt;&nbsp;3&nbsp;mm for "
                        "timing.  A fair referee will ask whether the looser timing radius was "
                        "actually optimised or merely assumed.  We answer it two complementary ways, "
                        "at <em>all six energies</em>, reusing the headline&rsquo;s exact Method-A "
                        "formula, event cuts, data-derived centroid and Gaussian-core fit.  "
                        "<strong>(1) The joint optimisation</strong> &mdash; the actual single-best-"
                        "E<sub>meas</sub>-bin estimator, re-selected at each radius (this is literally "
                        "what sets the headline; our replica reproduces the published per-energy "
                        "&sigma;<sub>t</sub> at 3&nbsp;mm to &lt;0.5&nbsp;ps).  <strong>(2) A stable "
                        "selection</strong> &mdash; a fixed top-2% / top-10% by &Sigma;A<sub>LG</sub>, "
                        "which freezes the E<sub>meas</sub> cut so the <em>pure</em> radius/position "
                        "effect can be read off a smooth curve.  Generated by "
                    ...
                    plots=[
                        PlotEntry(
                            ...
                            caption=(
                                ...
                                "fiducial radius, one curve per energy, with Gaussian-fit error bars.  "
                                "Re-optimising the E<sub>meas</sub> bin at each radius is jumpy by "
                                "construction (a single narrow bin), so the message is the robust trend: "
                                "<strong>no radius robustly beats r&nbsp;=&nbsp;3&nbsp;mm at any energy</strong>, "
                                "and isolated low spikes (e.g. 150&nbsp;GeV at 2.25&nbsp;mm) are fluctuations, "
                                "not real optima."
                            ),
                            width_pct=66,
                        ),
                        PlotEntry(
                            ...
                            caption=(
                                ...
                                "curves are smooth: a shallow dependence at every energy (higher energy "
                                "&rarr; lower &sigma;<sub>t</sub>), with r&nbsp;=&nbsp;3&nbsp;mm near-optimal "
                                "throughout &mdash; the optimum itself at 25&nbsp;GeV and within "
                                "~1&ndash;2&nbsp;ps of it at higher energies."
                            ),
                            width_pct=66,
                        ),
                        PlotEntry(
                            ...
                            caption=(
                                "<b>Headline-energy detail (150&nbsp;GeV)</b> &mdash; top-2% and top-10% "
                                "both show a shallow optimal plateau for r&nbsp;&le;&nbsp;2.5&nbsp;mm and "
                                "gentle degradation beyond.  The error bars show the r&nbsp;&le;&nbsp;2.5&nbsp;mm "
                                "points are a flat basin (consistent within ~1&sigma;); 2.25&nbsp;mm is the "
                                "lowest marker but not statistically distinct from its neighbours."
                            ),
                            width_pct=66,
                        ),
                    ],
                    finding=(
                        "<strong>3&nbsp;mm is the optimal choice for our estimator &mdash; the scan "
                        "vindicates it rather than merely permitting it.</strong>  Two effects "
                        "trade off.  (i) The <em>average</em> event&rsquo;s resolution has a shallow "
                        "optimal plateau for r&nbsp;&le;&nbsp;2.5&nbsp;mm and degrades gently beyond "
                        "(the outer ring is lower-amplitude, higher-walk) &mdash; so we do not want "
                        "a much looser circle.  (ii) But the headline uses the single <em>best</em> "
                        "E<sub>meas</sub> bin, which needs statistics to isolate the cleanest slice: "
                        "at r&nbsp;&lt;&nbsp;3&nbsp;mm (~155k fiducial events) it reaches "
                        "<strong>27.4&nbsp;ps</strong>, whereas tightening to 2.5&nbsp;mm shrinks the "
                        "selection pool and gives a <em>worse</em> 28.1&nbsp;ps.  The two effects "
                        "balance right at 3&nbsp;mm.  The 27.4&nbsp;ps best bin is run-folded "
                        "out-of-sample stable (not a lucky bin), and the lone 24.5&nbsp;ps point at "
                        "2.25&nbsp;mm is an isolated fluctuation (its neighbours are 28&ndash;31&nbsp;ps) "
                        "&mdash; exactly the kind of single-radius cherry-pick we reject.  The joint "
                        "view above shows the same verdict holds at <em>every</em> energy, not just the "
                        "headline: no radius robustly beats 3&nbsp;mm.  Net: the timing fiducial is set "
                        "by an explicit optimisation, and 3&nbsp;mm wins."
                    ),
                ),
                Subsection(

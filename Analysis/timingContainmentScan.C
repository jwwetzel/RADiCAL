...
//
// ── Output ───────────────────────────────────────────────────────────────────
//   Analysis/Output/Summary/timing_containment_scan.pdf   (4 pages)
//   Analysis/Output/Summary/timing_containment_scan.root
...
void timingContainmentScan()
{
    ...
    // Output PDF
    // =========================================================================
    TString outPDF  = "Analysis/Output/Summary/timing_containment_scan.pdf";
    TString outROOT = "Analysis/Output/Summary/timing_containment_scan.root";

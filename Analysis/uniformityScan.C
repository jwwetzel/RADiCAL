...
//
// -- Output -----------------------------------------------------------------
//   Analysis/Output/Summary/uniformity_scan.pdf   (3 pages)
//   Analysis/Output/Summary/uniformity_scan.root
//
...
void uniformityScan()
{
    ...
    // Output PDF
    // =========================================================================
    TString outPDF  = "Analysis/Output/Summary/uniformity_scan.pdf";
    TString outROOT = "Analysis/Output/Summary/uniformity_scan.root";

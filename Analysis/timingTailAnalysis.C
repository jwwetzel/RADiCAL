...
//
// Output: Analysis/Output/Summary/timing_tails.{png,pdf} + console stats.
// ============================================================================
...
void timingTailAnalysis()
{
    ...
    TFile* f = TFile::Open("Analysis/Output/150GeV/ntuple.root");
    ...
    c->Print("Analysis/Output/Summary/timing_tails.png");
    c->Print("Analysis/Output/Summary/timing_tails.pdf");

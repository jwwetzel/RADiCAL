...
//
// Output:
//   Analysis/Output/Summary/channel_calibration.pdf  (3 pages)
//   Analysis/Output/Summary/channel_calibration.root (g_i graphs, constants)
//
...
void channelCalibration()
{
    ...
    for (int iRun = 0; iRun < kNRuns; ++iRun) {
        ...
        TFile* f = TFile::Open(TString("Analysis/Output/") + rc.label + "/ntuple.root");
    ...
    // Output
    // =========================================================================
    TString outPDF = "Analysis/Output/Summary/channel_calibration.pdf";
    TString outROOT= "Analysis/Output/Summary/channel_calibration.root";
